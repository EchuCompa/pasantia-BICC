...
In particular, we develop a simple algorithm applicable to polytrees whose complexity depends on the maximum degree of a node. 
\echu{Acá también dejo dos opciones, la opción más por arriba y la opción más descriptiva.}
