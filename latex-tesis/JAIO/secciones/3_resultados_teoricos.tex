...
with a polynomial (although of high degree) complexity. We note that there are more modern and asimptotically better algorithms \parencite{huber2006fast}, but we believe that the hidden constants in them make them inefficient for the input sizes we consider.
